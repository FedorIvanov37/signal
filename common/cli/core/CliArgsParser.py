...
class CliArgsParser(ArgumentParser):
    ...
    def init_arguments(self):
        ...
        self.add_argument("-d", "--dir", type=str, default=None,
                          help="Directory with transaction files to parse. Signal will try to parse them one by one")

        self.add_argument("-a", "--address", default=self.config.host.host, action="store",
