...
class Ui_FieldDataSet(object):
    def setupUi(self, FieldDataSet):
        ...
        self.CheckBoxUtrnno = QtWidgets.QCheckBox(parent=self.groupBox_2)
        self.CheckBoxUtrnno.setObjectName("CheckBoxUtrnno")
        self.gridLayout_4.addWidget(self.CheckBoxUtrnno, 5, 0, 1, 1)
