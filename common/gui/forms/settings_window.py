...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        SettingsWindow.setMinimumSize(QtCore.QSize(420, 570))
        SettingsWindow.setMaximumSize(QtCore.QSize(420, 570))
        self.gridLayout_8 = QtWidgets.QGridLayout(SettingsWindow)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.MainTabs = QtWidgets.QTabWidget(parent=SettingsWindow)
        self.MainTabs.setObjectName("MainTabs")
        self.General = QtWidgets.QWidget()
        self.General.setObjectName("General")
        self.gridLayout_14 = QtWidgets.QGridLayout(self.General)
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.ConnectionBox)
        ...
        self.gridLayout_2.addWidget(self.KeepAliveInterval, 2, 1, 1, 1)
        self.gridLayout_14.addWidget(self.ConnectionBox, 0, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.LogStorageDepth, 1, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.DebugLevel, 0, 3, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=self.LogBox)
        self.label_4.setObjectName("label_4")
        self.gridLayout_6.addWidget(self.label_4, 0, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(99, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_6.addItem(spacerItem1, 5, 2, 1, 2)
        spacerItem2 = QtWidgets.QSpacerItem(99, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_6.addItem(spacerItem2, 4, 2, 1, 2)
        self.PrintSubfields = QtWidgets.QCheckBox(parent=self.LogBox)
        self.PrintSubfields.setObjectName("PrintSubfields")
        self.gridLayout_6.addWidget(self.PrintSubfields, 4, 0, 1, 2)
        spacerItem3 = QtWidgets.QSpacerItem(73, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_6.addItem(spacerItem3, 2, 2, 1, 2)
        self.PrintDescription = QtWidgets.QCheckBox(parent=self.LogBox)
        self.PrintDescription.setObjectName("PrintDescription")
        self.gridLayout_6.addWidget(self.PrintDescription, 5, 0, 1, 2)
        spacerItem4 = QtWidgets.QSpacerItem(99, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_6.addItem(spacerItem4, 3, 2, 1, 2)
        self.LogBackupStorageExists = QtWidgets.QCheckBox(parent=self.LogBox)
        self.LogBackupStorageExists.setObjectName("LogBackupStorageExists")
        self.gridLayout_6.addWidget(self.LogBackupStorageExists, 1, 0, 1, 1)
        self.gridLayout_14.addWidget(self.LogBox, 1, 0, 1, 1)
        self.OnStartupBox = QtWidgets.QGroupBox(parent=self.General)
        self.OnStartupBox.setObjectName("OnStartupBox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.OnStartupBox)
        ...
        self.verticalLayout.addWidget(self.ConnectOnStartup)
        ...
        self.verticalLayout.addWidget(self.ProcessDefaultDump)
        self.ApiRunGeneral = QtWidgets.QCheckBox(parent=self.OnStartupBox)
        self.ApiRunGeneral.setObjectName("ApiRunGeneral")
        self.verticalLayout.addWidget(self.ApiRunGeneral)
        self.LoadSpecGeneral = QtWidgets.QCheckBox(parent=self.OnStartupBox)
        self.LoadSpecGeneral.setObjectName("LoadSpecGeneral")
        self.verticalLayout.addWidget(self.LoadSpecGeneral)
        self.ShowLicense = QtWidgets.QCheckBox(parent=self.OnStartupBox)
        self.ShowLicense.setObjectName("ShowLicense")
        self.verticalLayout.addWidget(self.ShowLicense)
        self.gridLayout_14.addWidget(self.OnStartupBox, 2, 0, 1, 1)
        ...
        self.gridLayout_14.addWidget(self.GeneralButtonBox, 3, 0, 1, 1)
        ...
        self.gridLayout_16 = QtWidgets.QGridLayout(self.Spec)
        self.gridLayout_16.setObjectName("gridLayout_16")
        self.SpecBox = QtWidgets.QGroupBox(parent=self.Spec)
        self.SpecBox.setObjectName("SpecBox")
        self.gridLayout_15 = QtWidgets.QGridLayout(self.SpecBox)
        self.gridLayout_15.setObjectName("gridLayout_15")
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.StorageDepth = QtWidgets.QSpinBox(parent=self.SpecBox)
        self.StorageDepth.setMinimum(1)
        self.StorageDepth.setMaximum(99999)
        self.StorageDepth.setObjectName("StorageDepth")
        self.gridLayout_4.addWidget(self.StorageDepth, 5, 1, 1, 1)
        self.RewriteLocalSpec = QtWidgets.QCheckBox(parent=self.SpecBox)
        self.RewriteLocalSpec.setObjectName("RewriteLocalSpec")
        self.gridLayout_4.addWidget(self.RewriteLocalSpec, 3, 0, 1, 1)
        self.CopySpecUrl = QtWidgets.QPushButton(parent=self.SpecBox)
        self.CopySpecUrl.setObjectName("CopySpecUrl")
        self.gridLayout_4.addWidget(self.CopySpecUrl, 1, 1, 1, 1)
        self.RemoteSpecUrl = QtWidgets.QLineEdit(parent=self.SpecBox)
        self.RemoteSpecUrl.setObjectName("RemoteSpecUrl")
        self.gridLayout_4.addWidget(self.RemoteSpecUrl, 1, 0, 1, 1)
        self.LoadSpec = QtWidgets.QCheckBox(parent=self.SpecBox)
        self.LoadSpec.setObjectName("LoadSpec")
        self.gridLayout_4.addWidget(self.LoadSpec, 2, 0, 1, 1)
        self.BackupLocalSpecStartup = QtWidgets.QCheckBox(parent=self.SpecBox)
        self.BackupLocalSpecStartup.setObjectName("BackupLocalSpecStartup")
        self.gridLayout_4.addWidget(self.BackupLocalSpecStartup, 9, 0, 1, 1)
        self.BackupLocalSpecShutdown = QtWidgets.QCheckBox(parent=self.SpecBox)
        self.BackupLocalSpecShutdown.setObjectName("BackupLocalSpecShutdown")
        self.gridLayout_4.addWidget(self.BackupLocalSpecShutdown, 10, 0, 1, 1)
        self.line_3 = QtWidgets.QFrame(parent=self.SpecBox)
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout_4.addWidget(self.line_3, 4, 0, 1, 2)
        self.SpecBackupStorageExists = QtWidgets.QCheckBox(parent=self.SpecBox)
        self.SpecBackupStorageExists.setObjectName("SpecBackupStorageExists")
        self.gridLayout_4.addWidget(self.SpecBackupStorageExists, 5, 0, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.SpecBox, 0, 0, 1, 1)
        ...
        self.gridLayout_16.addWidget(self.SpecificationButtonBox, 1, 0, 1, 1)
        ...
        self.gridLayout_13 = QtWidgets.QGridLayout(self.ApiBox)
        ...
        self.gridLayout_9.addWidget(self.ApiPort, 0, 2, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=self.ApiBox)
        self.label_2.setObjectName("label_2")
        self.gridLayout_9.addWidget(self.label_2, 0, 0, 1, 1)
        self.ApiTimeout = QtWidgets.QSpinBox(parent=self.ApiBox)
        self.ApiTimeout.setSpecialValueText("")
        self.ApiTimeout.setMinimum(1)
        self.ApiTimeout.setMaximum(999)
        self.ApiTimeout.setObjectName("ApiTimeout")
        self.gridLayout_9.addWidget(self.ApiTimeout, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.ApiButtonBox, 5, 0, 1, 1)
        ...
        spacerItem12 = QtWidgets.QSpacerItem(146, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.UserGuideLink = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.UserGuideLink.setFont(font)
        self.UserGuideLink.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.UserGuideLink.setObjectName("UserGuideLink")
        self.horizontalLayout_5.addWidget(self.UserGuideLink)
        ...
        self.gridLayout_11.addLayout(self.horizontalLayout_5, 4, 0, 1, 3)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.label_3.setText(_translate("SettingsWindow", ":"))
        ...
        self.ReduceKeepAlive.setText(_translate("SettingsWindow", "Hide Keep-Alive in log"))
        self.label_4.setText(_translate("SettingsWindow", "Debug level"))
        self.PrintSubfields.setText(_translate("SettingsWindow", "Parse complex fields"))
        self.PrintDescription.setText(_translate("SettingsWindow", "Print fields description"))
        self.LogBackupStorageExists.setText(_translate("SettingsWindow", "Logfiles backup storage depth"))
        ...
        self.ApiRunGeneral.setText(_translate("SettingsWindow", "Run API mode"))
        self.LoadSpecGeneral.setText(_translate("SettingsWindow", "Load remote specification"))
        ...
        self.BackupLocalSpecStartup.setText(_translate("SettingsWindow", "Backup specification on startup"))
        self.BackupLocalSpecShutdown.setText(_translate("SettingsWindow", "Backup specification on shutdown"))
        self.SpecBackupStorageExists.setText(_translate("SettingsWindow", "Backup storage depth"))
        ...
        self.ApiTimeout.setSuffix(_translate("SettingsWindow", " sec"))
        ...
        self.ApiRun.setText(_translate("SettingsWindow", "Run API on startup"))
        ...
        self.UserGuideLink.setText(_translate("SettingsWindow", "user guide"))
